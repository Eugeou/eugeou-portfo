import { Tooltip } from "@/components/shared-components/elements/tooltip";
    ...
    <div className="flex items-center gap-3">
          ...
          >
            <div className="w-6 h-6 bg-white rounded-full flex items-center justify-center">
              <svg
                ...
                height="16"
                viewBox="0 0 20 20"
                fill={minZoomReached ? "currentColor" : "#ccc"}
              >
          ...
          >
            <div className="w-6 h-6 bg-white rounded-r-lg flex items-center justify-center">
              <svg
                ...
                height="16"
                viewBox="0 0 20 20"
                fill={maxZoomReached ? "currentColor" : "#ccc"}
              >
      ...
      <Tooltip content="Default view">
        <button
          ...
          className="p-[3px] mt-[5px] bg-white border border-gray-300 rounded-md hover:bg-gray-50"
          title="Default view"
        >
          <svg
            width="22"
