  ...
  return (
    <div className="flex items-center gap-3">
      <div className="flex border border-gray-300 rounded-lg">
        <button
          className="p-0 rounded-l-lg bg-white hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
          disabled={minZoomReached}
          onClick={handleZoomIn}
          title="Zoom out"
        >
          <div className="w-6 h-6 bg-white rounded-full flex items-center justify-center">
            <svg width="16" height="16" viewBox="0 0 20 20" fill={minZoomReached ? "currentColor" : "#ccc"}>
              <path d="M10 4a1 1 0 011 1v4h4a1 1 0 110 2h-4v4a1 1 0 11-2 0v-4H5a1 1 0 110-2h4V5a1 1 0 011-1z"/>
            </svg>
          </div>
        </button>
        <button
          className="p-0 border-l border-gray-300 rounded-r-lg bg-white hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
          disabled={maxZoomReached}
          onClick={handleZoomOut}
          title="Zoom in"
        >
          <div className="w-6 h-6 bg-white rounded-r-lg flex items-center justify-center">
            <svg width="16" height="16" viewBox="0 0 20 20" fill={maxZoomReached ? "currentColor" : "#ccc"}>
      ...
      <button
        ...
        className="p-[2px] bg-white border border-gray-300 rounded-md hover:bg-gray-50"
        title="Default view"
      >
        <svg
          width="20"
