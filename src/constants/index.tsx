...
import {
  ...
  MyProjectPixelIcon,
  ContactPixelIcon,
} from "@/components/shared-components/pixel-icons";
...
export const menuItems = [
  { id: "Home", label: "Home", icon: HomePixelIcon },
  { id: "AboutMe", label: "About me", icon: UserPixelIcon },
...
export const aboutMeTabs = [
  {
    ...
    icon: <BiUser />,
    content:
      "Hi guys, my name is Nguyen Hoang Minh Quan. I'm an under-graduated student of The University of Information Technology. And I also known as a Frontend Developer.",
  },
  {
    id: 1,
    label: "Education",
    ...
    content:
      "I am currently pursuing a Bachelor's degree at The University of Information Technology. My focus is on Web Development and Software Engineering.",
  },
  {
    id: 2,
    label: "Objective",
    icon: <FaBullseye />,
    content:
      "Diligent and motivated individual with a foundation in frontend development, seeking an internship to apply skills in UI programming. Eager to gain hands-on experience, contribute to a skilled team, and deepen expertise in building reliable, scalable solutions. ",
  },
  {
    id: 3,
    label: "My Hobby",
    icon: <FaSmile />,
    content:
      "I enjoy coding, playing games, watching cartoons, and exploring new technologies in my free time.",
  },
];
